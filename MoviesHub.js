...
for (let i = 0; i < movies.length; i++) {
    contenedor.innerHTML +=
        '<div class="pelicula">' +
        '<img src="' + movies[i].imagen + '" alt="' + movies[i].nombre + '">' +
        '<div>' +
        '<h2>' + movies[i].nombre + '</h2>' +
        '<p><strong>Fecha de publicación:</strong> ' + movies[i].fechaDePublicacion + '</p>' +
        '<p><strong>Edad mínima:</strong> ' + movies[i].restriccionDeEdad + '+</p>' +
        '<p><strong>Descripción:</strong> ' + movies[i].descripcion + '</p>' +
        '<p><strong>Idioma original:</strong> ' + movies[i].idiomaOriginal + '</p>' +
        '<p><strong>Doblajes:</strong> ' + movies[i].doblajes.join(", ") + '</p>' +
        '<p><strong>Subtítulos:</strong> ' + movies[i].subtitulos.join(", ") + '</p>' +
        '</div>' +
        '</div>';
};
